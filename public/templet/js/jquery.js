...
$(function () {
    ...
    var h = $("#flashs .cbnitem").css("opacity", 0).length;
...
$(function () {
    var a = location.href;
    var b = 0;
    var c = $(".c_nav ul li").length;
    $(".c_nav ul li").each(function (e) {
    ...
    if (b == c) {
        $(".c_nav ul li:eq(0)").addClass("cur");
        $(".c_nav ul li:eq(0)").siblings("li").removeClass("cur");
    }
});
